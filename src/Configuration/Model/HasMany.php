...
/**
 * \Playground\Make\Configuration\Model\HasMany
 */
class HasMany extends ModelConfiguration implements Configuration\Contracts\WithSkeleton
{
    ...
    public function setOptions(array $options = []): self
    {
        ...
        if ($this->skeleton() && $this->accessor && $parent = $this->getParent()) {
            ...
            if (! $this->foreignKey) {
                $this->foreignKey = Str::of($this->accessor)->snake()->finish('_id')->toString();
            }
