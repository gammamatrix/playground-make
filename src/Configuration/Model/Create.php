...
/**
 * \Playground\Make\Configuration\Model\Create
 */
class Create extends ModelConfiguration implements Configuration\Contracts\WithSkeleton
{
    ...
    public function setOptions(array $options = []): self
    {
        ...
        if (! empty($options['primary'])
            ...
            if (! in_array($options['primary'], $allowed_primary)) {
                Log::warning(__('playground-make::model.Create.primary.unexpected', [
    ...
    public function addUnique(int $i, mixed $meta): self
    {
        if (empty($meta) || ! is_array($meta)) {
            throw new \RuntimeException(__('playground-make::model.Create.unique.invalid', [
                'i' => $i,
            ]));
        }
    ...
    {
        if (empty($column) || empty($meta) || ! is_array($meta)) {
            throw new \RuntimeException(__('playground-make::model.Create.date.invalid', [
                'column' => $column,
            ]));
        }
        $meta['column'] = $column;
    ...
    {
        if (empty($column) || empty($meta) || ! is_array($meta)) {
            throw new \RuntimeException(__('playground-make::model.Create.flag.invalid', [
                'column' => $column,
            ]));
        }
        $meta['column'] = $column;
    ...
    {
        if (empty($column) || empty($meta) || ! is_array($meta)) {
            throw new \RuntimeException(__('playground-make::model.Create.column.invalid', [
                'column' => $column,
            ]));
        }
        $meta['column'] = $column;
    ...
    {
        if (empty($column) || empty($meta) || ! is_array($meta)) {
            throw new \RuntimeException(__('playground-make::model.Create.permission.invalid', [
                'column' => $column,
            ]));
        }
        $meta['column'] = $column;
    ...
    {
        if (empty($column) || empty($meta) || ! is_array($meta)) {
            throw new \RuntimeException(__('playground-make::model.Create.status.invalid', [
                'column' => $column,
            ]));
        }
        $meta['column'] = $column;
    ...
    {
        if (empty($column) || empty($meta) || ! is_array($meta)) {
            throw new \RuntimeException(__('playground-make::model.Create.matrix.invalid', [
                'column' => $column,
            ]));
        }
        $meta['column'] = $column;
    ...
    {
        if (empty($column) || empty($meta) || ! is_array($meta)) {
            throw new \RuntimeException(__('playground-make::model.Create.ui.invalid', [
                'column' => $column,
            ]));
        }
        $meta['column'] = $column;
    ...
    {
        if (empty($column) || empty($meta) || ! is_array($meta)) {
            throw new \RuntimeException(__('playground-make::model.Create.json.invalid', [
                'column' => $column,
            ]));
        }
        $meta['column'] = $column;
